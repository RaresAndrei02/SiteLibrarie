<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ProfilUtilizator.aspx.cs" Inherits="SiteLibrarie.ProfilUtilizator" %>
            ...
            <div class="col-md-5">
                    ...
                    <div class="card-body" id="card">
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col">
                                <center>
                                    <h3><b>Profilul tau</b></h3>

                                    <span>Staus - </span>
                                    <asp:Label Class="badge badge-pill badge-info" ID="Label1" runat="server" Text="Statusul tau"></asp:Label>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="ZZ/LL/AAAA" TextMode="Date"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="07********" TextMode="Phone"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label>Oras</label>
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox6" runat="server" placeholder="Oras" TextMode="SingleLine"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox7" runat="server" placeholder="Cod Postal" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                         ...
                         <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Scrie adresa completa de domiciliu" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </div>
                ...
                <div class="row">
                            ...
                            <div class="col-md-4">
                                <label>Parola</label>
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox9" runat="server" placeholder="Parola veche" TextMode="Password" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox10" runat="server" placeholder="Parola noua" TextMode="Password" ReadOnly="False"></asp:TextBox>
                                </div>
                            </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                       <center>
                          <div class="form-group">
                             <asp:Button ID="Button4" runat="server" Text="Modifica" Class="btn btn-primary btn-lg" />
                        </div>    
                       </center>
                ...
                <div class="card">
                    <div class="card-body" id="card">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="imgs/imgs/books1.png" width="100px" />
                                </center>
                            </div>
                        </div>
                         ...
                         <div class="row">
                            <div class="col">
                                <center>
                                    <h3><b>Cartile tale</b></h3>

                                    
                                    <asp:Label Class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Informatii despre cartile tale"></asp:Label>
                                </center>
                            </div>
                        </div>
                        <div class="row">
