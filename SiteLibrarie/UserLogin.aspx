<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="SiteLibrarie.UserLogin" %>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                            <div class="col">                              
                                ...
                                <div class="form-group">
                                     <a href="InregistrareUtilizator.aspx"><input id="Button2" type="button" value="Inregistreaza-te" class="btn btn-info btn-block btn-lg" /></a>
                                </div>
                            </div>
                      </div>  
